...
\begin{table}[h]
	...
	\begin{tabular}{lrrrr}
		\hline
		 &  &  & BF$_{1}$$_{0}$ & error \%  \\
		\hline
		High Load N2pc & - & Low Load N2pc & 0.279 & 0.021  \\
		High Load Ptc & - & Low Load Ptc & 3.304 & 0.003  \\
		High Load SPCN & - & Low Load SPCN & 0.621 & 0.006  \\
		High Load SPCN2 & - & Low Load SPCN2 & 0.646 & 0.005  \\
		\hline
	\end{tabular} 
	\end{center}
\end{table}
