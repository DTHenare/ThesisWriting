...
pdf("Figures/SAWMDIST_noCorrelogram.pdf", width = 7, paper = "special")
corrplot(no.area.corr$r, method = "ellipse", type = "lower",p.mat = no.area.corr$P, sig.level = 0.05, insig = "blank")
dev.off()
pdf("Figures/SAWMDIST_yesCorrelogram.pdf", width = 7, paper = "special")
...
pdf("Figures/SAWMDIST_noScatterPlot.pdf", width = 7, paper = "special")
...
#include_graphics("Figures/SAWMDIST_noScatterPlot.pdf", auto_pdf = TRUE)
```

```{r SDcorrelogramLow, fig.cap = "This is where I'd put the figure caption.", fig.align = "center"}
#include_graphics("Figures/SAWMDIST_noCorrelogram.pdf", auto_pdf = TRUE)
```

```{r SDcorrelogramHigh, fig.cap = "This is where I'd put the figure caption.", fig.align = "center"}
#include_graphics("Figures/SAWMDIST_yesCorrelogram.pdf", auto_pdf = TRUE)
```
