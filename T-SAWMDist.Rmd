...
\begin{table}[h]
	...
	\label{tab:SD_BayesTargFollowup}
...
\begin{table}[h]
	...
	\label{tab:SD_BayesDistFollowup}
	\begin{tabular}{lrrrrr}
		\hline
		 &  &  & BF$_{1}$$_{0}$ & BF$_{0}$$_{1}$ & error \%  \\
		\hline
