...
In the first study we wanted to develop a detailed understanding of the change detection paradigm, and specifically the effect that irrelevant distractors have on performance in tihs kind of working memory task. At this stage we had started planning \textit{Study Two} which would be using a change detection paradigm in conjunction with EEG and therefore decided it would be important to have a systematic understanding of the dynamics of the change detection task. Specifically, we wanted to know the effect that irrelevant objects had on a trial-by-trial basis, as well as across a longer time period. In reviewing the literature we could not find any experiments which allowed for the dissociation of trial-by-trial changes in distractor presence, from longterm changes in the distractor context. As a result we developed this blocked design which would allow us to separate trial-by-trial effects from block-by-block effecs. This would provide an important base of knowledge for developing the tasks used in the subsequent EEG investigations, as well as for interpreting their results.
