...
TM.hPlot <- ggplot(regressSheet, aes(x=Capacity, y=m1Residual)) + geom_point() +geom_smooth(method=lm)+labs(y = "Residual sensitivity", x= "Working memory capacity") +theme_apa()
pdf("C:/Users/dhen061/Desktop/ThesisWriting/Figures/WMBehav_TM_hPlot.pdf", width = 7, paper = "special")
TM.hPlot
dev.off()
```
...
include_graphics("C:/Users/dhen061/Desktop/ThesisWriting/Figures/WMBehav_TM_hPlot.pdf", auto_pdf = TRUE)
```
...
TI.hPlot <- ggplot(regressSheet, aes(x=Capacity, y=m1Residual)) + geom_point() +geom_smooth(method=lm)+labs(y = "Residual sensitivity", x= "Working memory capacity") +theme_apa()

pdf("C:/Users/dhen061/Desktop/ThesisWriting/Figures/WMBehav_TI_hPlot.pdf", width = 7, paper = "special")
TI.hPlot
dev.off()
...
include_graphics("C:/Users/dhen061/Desktop/ThesisWriting/Figures/WMBehav_TI_hPlot.pdf", auto_pdf = TRUE)
```
