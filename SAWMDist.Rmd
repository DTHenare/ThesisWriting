...
shorttitle        : "Working memory filtering and attentional control" #This is the running header
...
Some research has suggested working memory affects target processing, some have suggested it affects distractor processing. Heterogeneous effects of working memory on attention mechanisms may be a result of conflating working memory load and working memory filtering.
