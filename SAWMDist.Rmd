...
subData <-read.table("P:/dhen061/Experiment_1.1/EEG_Data/Output/Subtracted  Explore/SubtractedStatsAll.txt", header = TRUE)
...
longBehav$Load[longBehav$Load == "igh"] <- "No Dist"
longBehav$Load[longBehav$Load == "Hig"] <- "No Dist"
longBehav$Load[longBehav$Load == "_Lo"] <- "Dist"
longBehav$Load[longBehav$Load == "Low"] <- "Dist"
...
# Tidy the variable Names
longDist$Component[longDist$Component == "N2pc"] <- "P1pc"
longDist$Component[longDist$Component == "_Ptc"] <- "N2pc"
longDist$Component[longDist$Component == "SPCN"] <- "Ptc"
longDist$Component[longDist$Component == "PCN2"] <- "SPCN"
longDist$Load[longDist$Load == "Low_"] <- "No Dist"
longDist$Load[longDist$Load == "High"] <- "Dist"
...
# Tidy columns\
longTarg$Component[longTarg$Component == "N2pc"] <- "SPCNa"
longTarg$Component[longTarg$Component == "P1pc"] <- "N2pc"
longTarg$Component[longTarg$Component == "SPCN"] <- "SPCNb"
longTarg$Component[longTarg$Component == "PCN2"] <- "SPCNc"
longTarg$Load[longTarg$Load == "Low_"] <- "No Dist"
longTarg$Load[longTarg$Load == "High"] <- "Dist"
...
targ.interaction.load.emmeans <- emmeans(targ.aov, ~Load|Component)
targ.interaction.load.posthoc <- pairs(targ.interaction.load.emmeans)
targ.interaction.component.emmeans <- emmeans(targ.aov, ~Component|Load)
...
targ.interaction.load.posthoc.table <- xtable(summary(targ.interaction.load.posthoc), caption = "This is the table caption", label = "tab:TIntLoadLabel")
...
print(targ.interaction.load.posthoc.table, comment=FALSE, caption.placement = "top", latex.environments="flushleft")
