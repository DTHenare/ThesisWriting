...
```{r correlogramLow, fig.cap = "Correlogram showing the direction and strength of all significant correlations between behavioral and neural measures under low working memory load.", fig.align = "center"}
include_graphics("C:/Users/dhen061/Desktop/ThesisWriting/Figures/lowCorrelogram.pdf", auto_pdf = TRUE)
```

```{r correlogramHigh, fig.cap = "Correlogram showing the direction and strength of all significant correlations between behavioral and neural measures under high working memory load.", fig.align = "center"}
