...
erpData <-read.table("P:/dhen061/Experiment_1/EEG_Data/RAW_Files/Output-Final/Subtracted/Average_ERP_Data.txt", header = TRUE)
...
All statistical anaysis was performed in version 1.1.423 of RStudio [@rstudio_desk_2016] using `r cite_r("r-references.bib")`. The data and code used to generate this manuscript (including analyses and plots) can be found at https://osf.io/wm3t6/.
...
WMRTbyDISTP <- ggplot(lowAreaData, aes(x=WMRT, y=DistN)) + geom_point() +geom_smooth(method=lm) +theme_apa()
