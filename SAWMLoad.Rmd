...
```{r violinPlots, fig.cap = "Violin plots showing the effect of working memory load on A) Working memory response times in milliseconds, B) working memory accuracy in percent, C) visual search response times in milliseconds, and D) visual search accuracy in percent.", fig.align = "center"}
